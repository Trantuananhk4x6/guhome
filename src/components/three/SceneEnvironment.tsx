...
/**
 * Image-based lighting for the scene. An explicit HDRI wins, then a known drei
 * preset, then the local rig. Both remote paths are wrapped so a slow or
 * blocked CDN degrades to the rig instead of taking the canvas down.
 */
