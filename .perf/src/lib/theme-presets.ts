...
export const AMBER_NIGHT: ThemePreset = {
  ...
  dark: true,
  colors: {
    // Not #0C0B0A. A ground that close to absolute black compresses everything
    // near it: the hairlines measured 1.34:1 against it and read as absent, and
    // the espresso footer came out at 1.04:1 — an undifferentiated black slab.
    // Lifting the ground buys the room those elements need to be seen at all.
    canvas: '#14120E',
    surface: '#1D1913',
    surfaceAlt: '#272117',
    ink: '#F7F3EA',
